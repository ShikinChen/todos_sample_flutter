...
import 'package:todos/common/messages_all.dart';
...
class ArchSampleLocalizations {
  ...
  static Future<ArchSampleLocalizations> load(Locale locale) =>
      initializeMessage(locale.toString())
          .then((_) => ArchSampleLocalizations(locale));

  static ArchSampleLocalizations of(BuildContext context) =>
      Localizations.of<ArchSampleLocalizations>(
